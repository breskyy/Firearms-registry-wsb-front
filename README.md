...
└── styles/             # Tailwind, motyw, zmienne CSS

docs/                   # Analizy flow, mapowanie pól, weryfikacja UI↔API
...
Kontrakt API backendu opisany jest również w `src/imports/pasted_text/e-weapon-registry-api.md`.
