...
export function mapCameraStartError(err: unknown): string {
  ...
  if (err instanceof DOMException) {
    switch (err.name) {
      ...
      case "DevicesNotFoundError":
        return "Nie wykryto kamery. Wpisz kod promesy ręcznie w zakładce „Kod QR”.";
      case "NotReadableError":
      case "TrackStartError":
        return "Kamera jest zajęta przez inną aplikację. Zamknij ją i odśwież stronę.";
      case "OverconstrainedError":
      case "ConstraintNotSatisfiedError":
        return "Ta kamera nie obsługuje wymaganego trybu. Spróbuj ponownie lub wpisz kod ręcznie.";
      case "SecurityError":
        return INSECURE_CONTEXT_MESSAGE;
      default:
        break;
  ...
  return "Nie udało się uruchomić aparatu. Zezwól na dostęp do kamery po monicie przeglądarki lub wpisz kod ręcznie.";
}
